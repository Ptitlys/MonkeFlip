...
<section id="bloc" class="mt-4"> 
    ...
    <article class="row">
        ...
        <div class="ml-3 col offset-1">
            ...
            <?php
                echo '<img src=';
                echo base_url('public/images/favori_vide.png');
            ...
            <a href="<?php echo base_url('public/index.php/Main_controlleur/modifier_mon_produit') ?>"><p class="row-auto fond_violet_clair button text-center">Modifier<p></a>
