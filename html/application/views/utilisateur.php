<nav class="row pl-4 pr-3 justify-content-around align-items-center" id="menu">
    <a class="col" id="debut" class="pt-2" href="<?php echo base_url('index.php/Main_controlleur/index') ?>"><img src='<?php echo base_url('images/logo.png') ?>' height=90></a>
